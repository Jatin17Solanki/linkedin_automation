...
1. Open your Google Sheet: https://docs.google.com/spreadsheets/d/YOUR_GOOGLE_SHEET_DOCUMENT_ID
...
- Change the **"To"** field from `CONFIGURE_ME@gmail.com` to your email (e.g., `CONFIGURE_ME@example.com`)
